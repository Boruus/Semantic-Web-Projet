...
public class pokemonRDFGeneratorOld {
        ...
        try {
            ...
            for (String pageTitle : pokemonPages) {
                ...
                if (wikiContent != null && !wikiContent.isEmpty()) {
                    ...
                    String infoboxContent = PokemonInfoboxRDFGeneratorOld.extractInfobox(wikiContent, selectedInfoboxTypes);
                    if (infoboxContent != null) {
                        Model model = PokemonInfoboxRDFGeneratorOld.generateRDFForTCGPromoInfobox(infoboxContent, pageTitle);
    ...
    public static List<String> filterPagesWithInfoboxTypes(List<String> allPages, List<String> selectedInfoboxTypes) throws Exception {
        ...
        for (String pageTitle : allPages) {
            String wikiContent = PokemonInfoboxRDFGeneratorOld.getWikiContent(pageTitle);
            if (wikiContent != null && !wikiContent.isEmpty()) {
